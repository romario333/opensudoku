...
public class SudokuListActivity extends Activity{
			...
			public boolean setViewValue(View view, Cursor c,
            	...
            	if (view.getId() == R.id.detail_label) {
                	...
                	case SudokuGame.GAME_STATE_PLAYING:
                		detail = String.format("Playing (%s)", getTime(time));
                		break;
                	}
    ...
    public void onCreateContextMenu(ContextMenu menu, View view, ContextMenuInfo menuInfo) {
        ...
        // TODO:
        Cursor cursor = (Cursor) sudokuList.getAdapter().getItem(info.position);
        if (cursor == null) {
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        case MENU_ITEM_DELETE:
        	showDialog(DIALOG_DELETE_SUDOKU);
        	return true;
	...
	private OnItemClickListener sudokuListItemListener = new OnItemClickListener() {
